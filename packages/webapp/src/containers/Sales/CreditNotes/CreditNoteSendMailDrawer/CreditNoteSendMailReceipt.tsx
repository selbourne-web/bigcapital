...
export interface CreditNoteSendMailReceiptProps extends SendMailReceiptProps {
  // # Company name.
  ...
  showViewCreditNoteButton?: boolean;
  viewCreditNoteButtonLabel?: string;
  viewCreditNoteButtonOnClick?: () => void;
}

export function CreditNoteSendMailReceipt({
  // # Company name.
  companyLogoUri,
  companyName,
    ...
    <SendMailReceipt {...props}>
      <Stack spacing={16} textAlign={'center'}>
        ...
        <Stack spacing={8}>
          ...
          <x.span fontSize={'13px'} color="#404854">
            {creditNoteDateLabel} {creditNoteDate}
          </x.span>
        </Stack>
      </Stack>
      ...
      {showViewCreditNoteButton && (
        <SendMailReceipt.PrimaryButton
          primaryColor={'#000'}
          onClick={viewCreditNoteButtonOnClick}
        >
          {viewCreditNoteButtonLabel}
        </SendMailReceipt.PrimaryButton>
      )}
